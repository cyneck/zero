...
public class Tenant extends BaseEntity implements Serializable {
    ...
    public Tenant(String tenantId, String organCode, String companyName, String state, String contactName, String createStaffId, Date createTime, String modifyStaffId, Date modifyTime, String domainName, String tnameShort, Date beginDate, Date endDate, String contactPhone, String logoPath, String welcomeInfo, String saleCustName, String saleTaxIdNumber, String saleOpenBank, String saleAddrAndTel) {
        ...
        this.saleTaxIdNumber = saleTaxIdNumber;
        this.saleOpenBank = saleOpenBank;
        this.saleAddrAndTel = saleAddrAndTel;
    }
